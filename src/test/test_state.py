...
class StateTest(unittest.TestCase):
    ...
    def test_get_state_from_fen_en_passant(self):
        ...
        self.assertTrue(state.can_castle_kingside[chess.BLACK])
        self.assertTrue(state.can_castle_kingside[chess.WHITE])
        self.assertTrue(state.can_castle_queenside[chess.BLACK])
        self.assertTrue(state.can_castle_queenside[chess.WHITE])
    ...
    def test_get_state_from_fen_no_castling(self):
        ...
        self.assertFalse(state.can_castle_kingside[chess.BLACK])
        self.assertFalse(state.can_castle_kingside[chess.WHITE])
        self.assertFalse(state.can_castle_queenside[chess.BLACK])
        self.assertFalse(state.can_castle_queenside[chess.WHITE])
