...
class BoardTest(unittest.TestCase):
    ...
    def test_square_generator_whitepawns(self):
        self.board = Board()
        squares = [bb for bb in get_individual_ones_in_bb(self.board.WP.bb)]
        self.assertEqual(len(squares), 8)
        self.assertEqual(chess.BB_RANK_2, self.board.WP.bb)

    def test_square_generator_whiterooks(self):
        self.board = Board()
        squares = [bb for bb in get_individual_ones_in_bb(self.board.WR.bb)]
    ...
    def test_square_generator_whiteknights(self):
        self.board = Board()
        squares = [bb for bb in get_individual_ones_in_bb(self.board.WN.bb)]
        self.assertEqual(len(squares), 2)
    ...
    def test_square_generator_whitebishops(self):
        self.board = Board()
        squares = [bb for bb in get_individual_ones_in_bb(self.board.WB.bb)]
        self.assertEqual(len(squares), 2)
    ...
    def test_square_generator_whiteking(self):
        self.board = Board()
        squares = [bb for bb in get_individual_ones_in_bb(self.board.WK.bb)]
        self.assertEqual(len(squares), 1)
        self.assertEqual(squares[0], chess.BB_E1)

    def test_square_generator_whitequeen(self):
        self.board = Board()
        squares = [bb for bb in get_individual_ones_in_bb(self.board.WQ.bb)]
        self.assertEqual(len(squares), 1)
