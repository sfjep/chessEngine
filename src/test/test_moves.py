...
class MovesTest(unittest.TestCase):
    ...
    #     self.state_white_queenside_castle = State("3k4/8/8/8/8/8/8/R3K3 w Q - 0 1")
    ...
    def test_number_of_possible_actions_from_start(self):
        ...
        # self.assertEqual(result[2], 8902)
        # self.assertEqual(result[3], 197281)
        # self.assertEqual(result[4], 4865609)
        # self.assertEqual(result[5], 119060324)

    # def test_number_of_possible_actions_from_fen(self):
    #     state = State('rnbq1kr/pp1Pbppp/2p5/8/2B5/8/PP1NnPP/RNBQK2R w KQ - 1 8')
    #     result = {}

    #     for depth in range(1,6):
    #         state.get_possible_actions()
    #         result[depth] = len(state.possible_actions)

    #     self.assertEqual(result[1], 44)
    #     self.assertEqual(result[2], 1486)
    #     self.assertEqual(result[3], 62379)
    #     self.assertEqual(result[4], 2103487)
    #     self.assertEqual(result[5], 89941194)